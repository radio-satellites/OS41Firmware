...
void fsk4_correction(int16_t correction[4]){
    //Apply correction based on the input array
    fsk4_tones[0] = fsk4_tones[0] + correction[0];
    fsk4_tones[1] = fsk4_tones[1] + correction[1];
    fsk4_tones[2] = fsk4_tones[2] + correction[2];
    fsk4_tones[3] = fsk4_tones[3] + correction[3];
}
